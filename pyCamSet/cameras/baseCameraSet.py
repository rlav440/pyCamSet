...
def make_cam_dict(camera_names:list, extrinsic_matrices:list, intrinsic_matrices:list,
    ...
    for name, ext, int, dist in zip(camera_names,
                                    extrinsic_matrices,
                                    intrinsic_matrices,
                                    dist_coefs):
...
class CameraSet:
    ...
    It is a base class to manage dependancies. CameraSet is the intended class for general use.
    ...
    def __init__(self,
        ...
        all_good = all(
            [v is None for v in [camera_names, extrinsic_matrices, res, intrinsic_matrices, distortion_coefs]]
        )
        ...
        if camera_dict is None:
            if not all_good:
                raise ValueError("Initialising a CameraSet requires names, extrinsic, intrinsic and resolutions")
