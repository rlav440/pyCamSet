...
class AbstractTarget(ABC):
    ...
    Inheriting targets must define:
        - A function to detect themselves in an input image
        - the self.point_data array. For a target this is an array of the generic form
            (u,v ... w, n, 3) where u ... w are relevant dimensions, and n,3 is "n" 3d
            and co planar points.
            As an example, a cube forms a (6,n,3) point_data array, as there are 6
            co-planar faces with n points on each face
    ...
    Inheriting targets may also define:
        - a printable shape.
            is either the target, or can then be folded onto a base shape.
        - a plotting function.
            A 3d visualisation of the target.
    """
